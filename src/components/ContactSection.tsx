      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:samiapreity23dnt@gmail.com" className="text-gray-600 hover:text-primary">
                      samiapreity23dnt@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+8801723868841" className="text-gray-600 hover:text-primary">
                      +880 1723-868841
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Professional Profiles</h3>
              <div className="space-y-4">
                <a 
                ...
                <a 
                  href="https://codeforces.com/profile/ShinnirKolaChori" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-600 hover:text-gray-900"
                >
                ...
                <a 
                  href="https://lightoj.com/user/Samia%20Preity" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-600 hover:text-gray-900"
                >
